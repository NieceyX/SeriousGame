...
namespace Microsoft.MixedReality.Toolkit.Audio
{
    ...
    public class ActiveEvent
        ...
        /// </summary>
        private Transform emitterTransform = null;
        /// <summary>
        ...
        public void AddEventSource(AudioClip clip, AudioParameter parameter = null, AnimationCurve responseCurve = null, float startTime = 0)
        {
            if (this.rootEvent == null)
            {
                Debug.LogWarningFormat(this.emitterTransform, "AudioManager: Can't find audio event for {0}!", this.name);
